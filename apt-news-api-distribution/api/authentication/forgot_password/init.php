			...
			public function DoSignup(){
				...
				if($this->IsError == false){
					...
					if($FetchResponse['code'] == 200 ){
					    $this->userid = $FetchResponse['msg']->user_id;	
					}else{
						$this->IsError = true;
				...
				if($this->IsError == false){
					$update_values = "ucode::::$ucode";
			        $UpdateResponse = AptPdoUpdate(['Update'=>$update_values,'Condtion'=>"user_id::::$this->userid",'DbCon'=>$SystemDbConn,'TbName'=>'account_registration','EPass'=>EPASS,'AcceptNullUpdate'=>true]);
