<?php
	/*
	*@FileName - BrowserDetectionJsReadMe.php
	*@Desc - Document to use UserBrowser_detection.js(LiveJavascript)
	*@Author arpit sharma
	*/
	...
	<script>
		...
		imprint.test(browserTests).then(function(result){
			...
			audioFingerprint.run(function (fingerprint_2) {
				//alert(fingerprint_3);
				//alert(uid);
				//alert(fingerprint_browser());
				//alert(fingerprint_flash());
				//alert(fingerprint_canvas());
				//alert(fingerprint_connection());
				//alert(fingerprint_cookie());
				//alert(fingerprint_display());
				//alert(fingerprint_fontsmoothing());
				//alert(fingerprint_fonts());
				//alert(fingerprint_formfields());
				//alert(fingerprint_java());
				//alert(fingerprint_language());
				//alert(fingerprint_silverlight());
				//alert(fingerprint_os());
				//alert(fingerprint_timezone());
				//alert(fingerprint_touch());
				//alert(fingerprint_plugins());
				//alert(fingerprint_useragent());
				//alert(fingerprint_truebrowser());
