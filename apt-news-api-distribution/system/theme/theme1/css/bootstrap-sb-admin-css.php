<style>
    ...
    *::after {
    ...
    .bg-login-image {
      background: url("<?php echo current_protocol_domain; ?>/System/Assets/Image/page/undraw_authentication_fsn5.png");
      background-position: center;
      background-size: cover;
    }

    .bg-register-image {
      background: url("<?php echo current_protocol_domain; ?>/System/Assets/Image/page/undraw_Lighthouse_frb8.png");
      background-position: center;
      background-size: cover;
    }
