...
const EVENT_CLICK_DATA_API = `click${EVENT_KEY}${DATA_token}`;
const EVENT_KEYDOWN_DATA_API = `keydown${EVENT_KEY}${DATA_token}`;
const EVENT_KEYUP_DATA_API = `keyup${EVENT_KEY}${DATA_token}`;
